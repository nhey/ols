...
let sm_cov_params = [[9.30974511e-02f64, -1.34857729e-03f64], [-1.34857729e-03f64, 2.56600331e-05f64]]
let sm_params = [10.60349832f64, 0.59485944f64]

entry main (bsz: i64) =
  let (X,y) = (copy X, copy y)
  let n = 2
  let res = assert (bsz <= n) (ols.ols bsz X y)
  in (res.params, res.cov_params)
